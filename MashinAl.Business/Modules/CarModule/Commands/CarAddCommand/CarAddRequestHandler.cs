...
{
    internal class CarAddRequestHandler : IRequestHandler<CarAddRequest, Car>
    {
        private readonly ICarRepository carRepository;
        private readonly IIdentityService identityService;
        private readonly IFileService fileService;

        public CarAddRequestHandler(ICarRepository carRepository, IIdentityService identityService, IFileService fileService)
        {
        ...
        public async Task<Car> Handle(CarAddRequest request, CancellationToken cancellationToken)
        {
