...
{
    internal class CarRejectEmail
    {
        internal static string CarRejectMessage(string name,int carId, string markaName,string modelName, string reason)
        {
            return $@"
                                                        ...
                                                        <table cellpadding=""0"" cellspacing=""0"" width=""100%"" style=""mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"">
                                                            ...
                                                            <tr>
                                                                <td align=""center"" class=""es-m-txt-c"" style=""padding:0;Margin:0;padding-bottom:10px"">
                                                                    <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:35px;color:#333333;font-size:23px"">Elan İmtina</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align=""center"" class=""es-m-p0r es-m-p0l"" style=""Margin:0;padding-top:5px;padding-bottom:5px;padding-left:40px;padding-right:40px"">
                                                                    ...
                                                                    <p style=""Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px"">
                                                                        Sizin {markaName}, {modelName} | {carId} nömrəli avtomobil elanınız imtina edilmişdir! <br>
                                                                        İmtina səbəbi: <b>{reason}</b>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
