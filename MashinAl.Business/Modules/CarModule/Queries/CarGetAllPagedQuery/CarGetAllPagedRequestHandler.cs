...
{
    internal class CarGetAllPagedRequestHandler : IRequestHandler<CarGetAllPagedRequest, IPagedResponse<CarGetAllPagedDto>>
    {
        ...
        public CarGetAllPagedRequestHandler(ICarRepository carRepository, IMarkaRepository markaRepository,
        ...
        public async Task<IPagedResponse<CarGetAllPagedDto>> Handle(CarGetAllPagedRequest request, CancellationToken cancellationToken)
        {
            ...
            return query.ToPaging(request, m => m.CreatedAt);
        }
    }
}
