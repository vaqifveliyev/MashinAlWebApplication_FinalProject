...
{
    internal class CarGetAllByUserPagedRequestHandler : IRequestHandler<CarGetAllByUserPagedRequest, IPagedResponse<CarGetAllByUserPagedDto>>
    {
        ...
        public CarGetAllByUserPagedRequestHandler(ICarRepository carRepository, IMarkaRepository markaRepository,
        ...
        public async Task<IPagedResponse<CarGetAllByUserPagedDto>> Handle(CarGetAllByUserPagedRequest request, CancellationToken cancellationToken)
        {
            int userId = Convert.ToInt32(identityService.GetPrincipalId());

            var query = (from c in carRepository.GetAll()
                              ...
                              select new CarGetAllByUserPagedDto
                              {
                                  Id = c.Id,
                                  MarkaId = c.MarkaId,
                                  MarkaName = m.Name,
            ...
            return query.ToPaging(request, m => m.PublishedAt);
        }
    }
}
