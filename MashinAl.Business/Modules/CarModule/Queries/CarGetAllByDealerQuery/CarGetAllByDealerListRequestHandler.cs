...
{
    internal class CarGetAllByDealerListRequestHandler : IRequestHandler<CarGetAllByDealerListRequest, IEnumerable<CarGetAllByDealerListItem>>
    {
        ...
        public CarGetAllByDealerListRequestHandler(ICarRepository carRepository, IMarkaRepository markaRepository,
            ...
            ICarStatusRepository carStatusRepository, ICityRepository cityRepository, IIdentityService identityService, UserManager<MashinAlUser> userManager)
        {
        ...
        public async Task<IEnumerable<CarGetAllByDealerListItem>> Handle(CarGetAllByDealerListRequest request, CancellationToken cancellationToken)
        {
            var query = await (from c in carRepository.GetAll()
                              ...
                              where c.CreatedBy == request.Id
                               select new CarGetAllByDealerListItem
                              {
                                  Id = c.Id,
                                  MarkaId = c.MarkaId,
                                  MarkaName = m.Name,
